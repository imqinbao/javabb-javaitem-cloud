...
public class GenUtil {
    ...
    public void generatorCurd(String srcDir,GenConfig genConfig) throws Exception {
        ...
        if (CollUtil.isNotEmpty(genConfig.getModels())) {
            for (GenModel genModel : genConfig.getModels()) {
                ...
                String mName = cn.javabb.generator.util.StrUtil.isBlank(genModel.getModelName()) ? "" : genModel.getModelName();
    ...
    public static String getFileName(String srcDir, String template, TableInfo tableInfo, PackageConfig pc) {
        ...
        if (template.contains("entity.java.vm")) {
            ...
            // 也可以放在resource下面
            fileName = javaPath + cn.javabb.generator.util.StrUtil.replace(pc.getXml(), ".", "/") + File.separator + tableInfo.getXmlName() + ".xml";
        } else if (template.contains("controller.java.vm")) {
            fileName = javaPath + cn.javabb.generator.util.StrUtil.replace(pc.getController(), ".", "/") + File.separator + tableInfo.getControllerName() + ".java";
        }
        return fileName;
    }
}
