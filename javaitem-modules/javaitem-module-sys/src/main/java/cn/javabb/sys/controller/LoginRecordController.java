...
public class LoginRecordController extends BaseController {
    ...
    @PreAuthorize("hasAuthority('sys:loginRecord:list')")
    ...
    @PreAuthorize("hasAuthority('sys:loginRecord:save')")
    ...
    @PreAuthorize("hasAuthority('sys:loginRecord:update')")
    ...
    @PreAuthorize("hasAuthority('sys:loginRecord:remove')")
