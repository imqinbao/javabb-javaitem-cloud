...
public class OperRecordController extends BaseController {
    ...
    @PreAuthorize("hasAuthority('sys:operRecord:list')")
    ...
    @PreAuthorize("hasAuthority('sys:operRecord:save')")
    ...
    @PreAuthorize("hasAuthority('sys:operRecord:update')")
    ...
    @PreAuthorize("hasAuthority('sys:operRecord:remove')")
