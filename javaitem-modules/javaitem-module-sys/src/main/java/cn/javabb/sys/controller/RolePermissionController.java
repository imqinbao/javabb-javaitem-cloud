...
public class RolePermissionController extends BaseController {
    ...
    @PreAuthorize("hasAuthority('sys:rolePermission:list')")
    ...
    @PreAuthorize("hasAuthority('sys:rolePermission:save')")
    ...
    @PreAuthorize("hasAuthority('sys:rolePermission:update')")
    ...
    @PreAuthorize("hasAuthority('sys:rolePermission:remove')")
